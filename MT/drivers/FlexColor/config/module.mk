...
#
# \brief
# Segger Graphical user interface for embedded applications, FlexColor 
# driver config files.
#
################################################################################
# \copyright
...
#
MIDDLEWARE_EMWIN_FLEXCOLOR_CFG_NAME=MIDDLEWARE_EMWIN_FLEXCOLOR_CFG
...
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_FLEXCOLOR_CFG_NAME)
...
#
$(MIDDLEWARE_EMWIN_FLEXCOLOR_CFG_NAME)_INCLUDES=

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_FLEXCOLOR_CFG_NAME),\
