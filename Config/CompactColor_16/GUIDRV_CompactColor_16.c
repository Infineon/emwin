...
#define LCD_L0_GetDevData    LCD_L0_CompactColor_16_GetDevData
...
int  LCD_L0_Init(void) {
  ...
  GUI_DEVICE * pDevice;
  //
  // The purpose of the following lines is only to avoid warnings
  //
  ...
  pFunc = (void (*)(void))__GetDevDataDummy;
  _NumColors = (int)(PTR_ADDR)pFunc;
  #if LCD_CACHE
