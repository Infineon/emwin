...
# component hard FP, without operating system support and without touch support.
...
#
MIDDLEWARE_EMWIN_NOSNTS_HARDFP_NAME=MIDDLEWARE_EMWIN_NOSNTS_HARDFP
...
#
CY_COMP_NAME_DISPLAY=Segger emWin Core, no OS, no Touch, Hard FP v5.48
...
CY_COMP_DESCR=Segger Graphical user interface for embedded applications, \
	core software component hard FP, without operating system support and without touch support. \
	It is required in any emWin display applications.
...
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_NOSNTS_HARDFP_NAME)
...
#
$(MIDDLEWARE_EMWIN_NOSNTS_HARDFP_NAME)_INCLUDES=\
    -I$(CY_PSOC_LIB_COMP_MIDDLEWARE)/emWin/GUI/Libs/hardfp/COMPONENT_EMWIN_NOSNTS

ifeq ($(TOOLCHAIN),GCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_NOSNTS/TOOLCHAIN_GCC_ARM/libemWin_nosnts_cm4f_gcc.a
else
ifeq ($(TOOLCHAIN),IAR)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_NOSNTS/TOOLCHAIN_IAR/libemWin_nosnts_cm4f_iar.a
else
ifeq ($(TOOLCHAIN),ARMCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_NOSNTS/TOOLCHAIN_ARMC6/libemWin_nosnts_cm4f_armc6.ar
endif
endif
endif

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_NOSNTS_HARDFP_NAME),\
    $(lastword $(MAKEFILE_LIST)),\
    $(CY_EMWIN_LIB)\
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_NOSNTS/GUIConf.h))
