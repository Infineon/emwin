...
# component hard FP, without operating system support, with touch support.
# It is required in any emWin display applications which use touch input.
#
################################################################################
# \copyright
...
#
MIDDLEWARE_EMWIN_NOSTS_HARDFP_NAME=MIDDLEWARE_EMWIN_NOSTS_HARDFP
...
CY_COMP_DEPS= \
    ...
    $(CY_PSOC_LIB_COMP_MIDDLEWARE_BASE)/emWin/MT/core/config/nos

#
# Used by the build recipe for an ELF file to add this component
# to the list of components that must be included
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_NOSTS_HARDFP_NAME)
...
#
$(MIDDLEWARE_EMWIN_NOSTS_HARDFP_NAME)_INCLUDES=\
    -I$(CY_PSOC_LIB_COMP_MIDDLEWARE)/emWin/GUI/Libs/hardfp/COMPONENT_EMWIN_NOSTS

ifeq ($(TOOLCHAIN),GCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_NOSTS/TOOLCHAIN_GCC_ARM/libemWin_nosts_cm4f_gcc.a
else
ifeq ($(TOOLCHAIN),IAR)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_NOSTS/TOOLCHAIN_IAR/libemWin_nosts_cm4f_iar.a
else
ifeq ($(TOOLCHAIN),ARMCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_NOSTS/TOOLCHAIN_ARMC6/libemWin_nosts_cm4f_armc6.ar
endif
endif
endif

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_NOSTS_HARDFP_NAME),\
    $(lastword $(MAKEFILE_LIST)),\
    $(CY_EMWIN_LIB)\
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_NOSTS/GUIConf.h))
