...
#
# \brief
# Segger Graphical user interface for embedded applications, SPage driver. 
...
#
MIDDLEWARE_EMWIN_SPAGE_NAME=MIDDLEWARE_EMWIN_SPAGE
...
#
CY_COMP_DEPS=$(CY_PSOC_LIB_COMP_MIDDLEWARE_BASE)/emWin/MT/drivers/SPage/config

#
# Used by the build recipe for an ELF file to add this component
# to the list of components that must be included
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_SPAGE_NAME)
...
#
$(MIDDLEWARE_EMWIN_SPAGE_NAME)_INCLUDES=

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_SPAGE_NAME),\
