...
#
# \brief
# Segger Graphical user interface for embedded applications, Template 
# driver config files.
#
################################################################################
# \copyright
...
#
MIDDLEWARE_EMWIN_TEMPLATE_CFG_NAME=MIDDLEWARE_EMWIN_TEMPLATE_CFG
...
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_TEMPLATE_CFG_NAME)
...
#
$(MIDDLEWARE_EMWIN_TEMPLATE_CFG_NAME)_INCLUDES=

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_TEMPLATE_CFG_NAME),\
    $(lastword $(MAKEFILE_LIST)),\
    ../../../../Sample/LCDConf/GUIDRV_Template/LCDConf.h\
    ../../../../Sample/LCDConf/GUIDRV_Template/Generic/LCDConf.c\
    ../../../../Sample/DisplayDriver/Template/GUIDRV_Template.c\
    ../../../../Sample/DisplayDriver/Template/GUIDRV_Template.h))
