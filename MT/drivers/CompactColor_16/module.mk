...
# driver. Use it with any of Segger emWin Core software components.
#
################################################################################
# \copyright
...
#
MIDDLEWARE_EMWIN_COMPACTCOLOR_16_NAME=MIDDLEWARE_EMWIN_COMPACTCOLOR_16
...
#
CY_COMP_DEPS=$(CY_PSOC_LIB_COMP_MIDDLEWARE_BASE)/emWin/MT/drivers/CompactColor_16/config

#
# Used by the build recipe for an ELF file to add this component
# to the list of components that must be included
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_COMPACTCOLOR_16_NAME)
...
#
$(MIDDLEWARE_EMWIN_COMPACTCOLOR_16_NAME)_INCLUDES= \
	-I$(CY_PSOC_LIB_COMP_MIDDLEWARE)/emWin/Sample/DisplayDriver/CompactColor_16


$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_COMPACTCOLOR_16_NAME),\
    $(lastword $(MAKEFILE_LIST)),\
    ../../../Sample/DisplayDriver/CompactColor_16/GUIDRV_CompactColor_16.c\
    ../../../Sample/DisplayDriver/CompactColor_16/GUIDRV_CompactColor_16.h))
