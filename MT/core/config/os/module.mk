...
#
MIDDLEWARE_EMWIN_OS_CONF_NAME=MIDDLEWARE_EMWIN_OS_CONF
...
#
CY_COMP_NAME_DISPLAY=Segger emWin core config files with OS support v5.48

#
# The name in the form of an identifier ([a-z_][a-z0-9_]*).
# Used to generate directories in the IDE.
# 
CY_COMP_NAME_ID=middlewareemWinOSConf
...
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_OS_CONF_NAME)
...
#
$(MIDDLEWARE_EMWIN_OS_CONF_NAME)_INCLUDES=

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_OS_CONF_NAME),\
