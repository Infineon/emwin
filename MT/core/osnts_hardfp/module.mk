...
# component hard FP, with operating system support, without touch support.
# It is required in any emWin display applications which use OS.
#
################################################################################
# \copyright
...
#
MIDDLEWARE_EMWIN_OSNTS_HARDFP_NAME=MIDDLEWARE_EMWIN_OSNTS_HARDFP
...
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_OSNTS_HARDFP_NAME)
...
#
$(MIDDLEWARE_EMWIN_OSNTS_HARDFP_NAME)_INCLUDES=\
    -I$(CY_PSOC_LIB_COMP_MIDDLEWARE)/emWin/GUI/Libs/hardfp/COMPONENT_EMWIN_OSNTS

ifeq ($(TOOLCHAIN),GCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_OSNTS/TOOLCHAIN_GCC_ARM/libemWin_osnts_cm4f_gcc.a
else
ifeq ($(TOOLCHAIN),IAR)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_OSNTS/TOOLCHAIN_IAR/libemWin_osnts_cm4f_iar.a
else
ifeq ($(TOOLCHAIN),ARMCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_OSNTS/TOOLCHAIN_ARMC6/libemWin_osnts_cm4f_armc6.ar
endif
endif
endif

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_OSNTS_HARDFP_NAME),\
    $(lastword $(MAKEFILE_LIST)),\
    $(CY_EMWIN_LIB)\
    ../../../GUI/Libs/hardfp/COMPONENT_EMWIN_OSNTS/GUIConf.h))
