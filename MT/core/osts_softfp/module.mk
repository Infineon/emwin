...
# component soft FP, with operating system and touch support.
...
#
MIDDLEWARE_EMWIN_OSTS_SOFTFP_NAME=MIDDLEWARE_EMWIN_OSTS_SOFTFP
...
#
CY_COMP_NAME_DISPLAY=Segger emWin Core, OS, Touch, Soft FP v5.48
...
CY_COMP_DESCR=Segger Graphical user interface for embedded applications, \
	core software component soft FP, with operating system and touch support. \
	It is required in any emWin display applications which use OS and touch input.
...
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_OSTS_SOFTFP_NAME)
...
#
$(MIDDLEWARE_EMWIN_OSTS_SOFTFP_NAME)_INCLUDES=\
    -I$(CY_PSOC_LIB_COMP_MIDDLEWARE)/emWin/GUI/Libs/softfp/COMPONENT_EMWIN_OSTS

ifeq ($(TOOLCHAIN),GCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_OSTS/TOOLCHAIN_GCC_ARM/libemWin_osts_gcc.a
else
ifeq ($(TOOLCHAIN),IAR)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_OSTS/TOOLCHAIN_IAR/libemWin_osts_iar.a
else
ifeq ($(TOOLCHAIN),ARMCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_OSTS/TOOLCHAIN_ARMC6/libemWin_osts_armc6.ar
endif
endif
endif

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_OSTS_SOFTFP_NAME),\
    $(lastword $(MAKEFILE_LIST)),\
    $(CY_EMWIN_LIB)\
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_OSTS/GUIConf.h))
