...
# component soft FP, without operating system support, with touch support.
...
#
MIDDLEWARE_EMWIN_NOSTS_SOFTFP_NAME=MIDDLEWARE_EMWIN_NOSTS_SOFTFP
...
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_NOSTS_SOFTFP_NAME)
...
#
$(MIDDLEWARE_EMWIN_NOSTS_SOFTFP_NAME)_INCLUDES=\
    -I$(CY_PSOC_LIB_COMP_MIDDLEWARE)/emWin/GUI/Libs/softfp/COMPONENT_EMWIN_NOSTS

ifeq ($(TOOLCHAIN),GCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_NOSTS/TOOLCHAIN_GCC_ARM/libemWin_nosts_gcc.a
else
ifeq ($(TOOLCHAIN),IAR)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_NOSTS/TOOLCHAIN_IAR/libemWin_nosts_iar.a
else
ifeq ($(TOOLCHAIN),ARMCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_NOSTS/TOOLCHAIN_ARMC6/libemWin_nosts_armc6.ar
endif
endif
endif

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_NOSTS_SOFTFP_NAME),\
    $(lastword $(MAKEFILE_LIST)),\
    $(CY_EMWIN_LIB)\
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_NOSTS/GUIConf.h))
