...
#
MIDDLEWARE_EMWIN_NOSNTS_SOFTFP_NAME=MIDDLEWARE_EMWIN_NOSNTS_SOFTFP
...
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_NOSNTS_SOFTFP_NAME)
...
#
$(MIDDLEWARE_EMWIN_NOSNTS_SOFTFP_NAME)_INCLUDES=\
    -I$(CY_PSOC_LIB_COMP_MIDDLEWARE)/emWin/GUI/Libs/softfp/COMPONENT_EMWIN_NOSNTS

ifeq ($(TOOLCHAIN),GCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_NOSNTS/TOOLCHAIN_GCC_ARM/libemWin_nosnts_gcc.a
else
ifeq ($(TOOLCHAIN),IAR)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_NOSNTS/TOOLCHAIN_IAR/libemWin_nosnts_iar.a
else
ifeq ($(TOOLCHAIN),ARMCC)
CY_EMWIN_LIB = \
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_NOSNTS/TOOLCHAIN_ARMC6/libemWin_nosnts_armc6.ar
endif
endif
endif

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_NOSNTS_SOFTFP_NAME),\
    $(lastword $(MAKEFILE_LIST)),\
    $(CY_EMWIN_LIB)\
    ../../../GUI/Libs/softfp/COMPONENT_EMWIN_NOSNTS/GUIConf.h))
