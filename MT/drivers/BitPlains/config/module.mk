...
#
# \brief
# Segger Graphical user interface for embedded applications, BitPlains driver 
# config files.
#
################################################################################
# \copyright
...
#
MIDDLEWARE_EMWIN_BITPLAINS_CFG_NAME=MIDDLEWARE_EMWIN_BITPLAINS_CFG
...
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_BITPLAINS_CFG_NAME)
...
#
$(MIDDLEWARE_EMWIN_BITPLAINS_CFG_NAME)_INCLUDES=

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_BITPLAINS_CFG_NAME),\
    $(lastword $(MAKEFILE_LIST)),\
    ../../../../Sample/LCDConf/GUIDRV_BitPlains/LCDConf.h\
    ../../../../Sample/LCDConf/GUIDRV_BitPlains/Generic/LCDConf.c))
