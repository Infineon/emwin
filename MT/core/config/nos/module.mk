...
#
# \brief
# Segger Graphical user interface for embedded applications, core configuration 
# files without OS support. 
#
################################################################################
# \copyright
...
#
MIDDLEWARE_EMWIN_NOS_CONF_NAME=MIDDLEWARE_EMWIN_NOS_CONF
...
#
$(CYARTIFACT)_OBJ_COMP_TAG_LIST += $(MIDDLEWARE_EMWIN_NOS_CONF_NAME)
...
#
$(MIDDLEWARE_EMWIN_NOS_CONF_NAME)_INCLUDES= \
    

$(eval $(call \
    CY_DECLARE_SWCOMP_OBJECT,$(MIDDLEWARE_EMWIN_NOS_CONF_NAME),\
    $(lastword $(MAKEFILE_LIST)),\
    ../../../../Sample/GUI_X/GUI_X.c\
    ../../../../Sample/GUIConf/GUIConf.c))
